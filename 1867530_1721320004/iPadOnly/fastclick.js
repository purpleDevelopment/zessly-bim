...
FastClick.prototype.onTouchStart = function(event) {
	...
	this.trackingClickStart = eventTimeStamp;
	...
	if ((eventTimeStamp - this.lastClickTime) < 200) {
		event.preventDefault();
	}
...
FastClick.prototype.onTouchEnd = function(event) {
	...
	if (targetTagName === 'label') {
		...
		if ((eventTimeStamp - trackingClickStart) > 100 || (this.deviceIsIOS && window.top !== window && targetTagName === 'input')) {
			this.targetElement = null;
			return false;
		}
